    ...
    <section class="main" style="background-image: url(images/slider2.jpg);">
        ...
        <nav>
            ...
            <ul class="menu" style="border-radius: 5px;">
                ...
                <li>
                <li><button type="button" onclick="window.open('http://localhost/ASHDMS/Documents/ASH Rules and Regulations.pdf','_blank')">School Rules</button>
                <li>
                <li><button type="button" onclick="showPaymentForm(true)">payment</button>
                <li>
                <li><button type="button" onclick="document.getElementById('id01').style.display='block'" style="">Contact Us</li>
